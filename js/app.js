...
firstapp.directive('workshop', function ($http, $filter) {
    return {
        templateUrl: 'views/directive/workshop.html',
        link: function ($scope, element, attrs) {
        }
    };
})

firstapp.directive('contentstrategy', function ($http, $filter) {
    return {
        templateUrl: 'views/directive/contentstrategy.html',
        link: function ($scope, element, attrs) {
        }
    };
})

firstapp.directive('digital', function ($http, $filter) {
    return {
        templateUrl: 'views/directive/digital.html',
        link: function ($scope, element, attrs) {
        }
    };
})

firstapp.directive('brandedcontent', function ($http, $filter) {
    return {
        templateUrl: 'views/directive/brandedcontent.html',
        link: function ($scope, element, attrs) {
        }
    };
})

firstapp.directive('internal', function ($http, $filter) {
    return {
        templateUrl: 'views/directive/internal.html',
        link: function ($scope, element, attrs) {
        }
    };
})

firstapp.directive('studio', function ($http, $filter) {
    return {
        templateUrl: 'views/directive/studio.html',
        link: function ($scope, element, attrs) {
        }
    };
})

firstapp.directive('design', function ($http, $filter) {
    return {
        templateUrl: 'views/directive/design.html',
        link: function ($scope, element, attrs) {
        }
    };
})

firstapp.directive('workshopInside', function ($http, $filter) {
    return {
        templateUrl: 'views/directive/workshopInside.html',
        link: function ($scope, element, attrs) {
        }
    };
})

firstapp.directive('brainwaveInside', function ($http, $filter) {
    return {
        templateUrl: 'views/directive/brainwaveInside.html',
        link: function ($scope, element, attrs) {
        }
    };
})

firstapp.directive('blog', function ($http, $filter) {
    return {
        templateUrl: 'views/directive/blog.html',
        link: function ($scope, element, attrs) {
        }
    };
})
